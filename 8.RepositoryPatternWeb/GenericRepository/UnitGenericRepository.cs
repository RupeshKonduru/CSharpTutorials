...
namespace RepositoryPatternWeb.UnitGenericRepository
{
    public class UnitGenericRepository<T> : IUnitGenericRepository<T>, IDisposable where T : class
    {
        private IDbSet<T> _entities;
        private string _errorMessage = string.Empty;
        private bool _isDisposed;
        public UnitGenericRepository(IUnitOfWork<EmployeeDBEntities> unitOfWork)
            : this(unitOfWork.Context)
        {
        }
        public UnitGenericRepository(EmployeeDBEntities context)
        {
            _isDisposed = false;
            Context = context;
        }
